...
public class VictorSwerveDriveModule extends SubsystemBase {
    ...
    // Falcon (Talon FX) controllers, sensors, PID
    private final TalonFX mAngleMotor;
    private final FeedbackDevice mEncoder = FeedbackDevice.; // integrated 2048 CPR Encoder
    // private CANPIDController m_pidControllerAngle;  // new for all Spark Max controllers // Closed-loop control is integrated with the TalonFX
    private CANCoder m_analogSensorAngle;  // new for TalonFX -- the integrated sensor isn't good enough
    ...
    public VictorSwerveDriveModule(int moduleNumber, TalonFX angleMotor, TalonFX driveMotor, double zeroOffset) {        this.moduleNumber = moduleNumber;
        ...
        // The integrated encoders get set to 0 on power cycle
