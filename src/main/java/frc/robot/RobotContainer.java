...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    // 
    // Thrower and meter bar
    //
    // --description--
    m_secondaryController_StickLeft.whenHeld( // first, --do a thing--... then, what? Does anything have to happen in parallel? 
      //activate thrower subsystem?
        //set motor up to speed
      // release a ball:
        //keep the motor working a certain amount of time (set command to stop)
      new SequentialCommandGroup()
    ); 
